...
export const MIGRATIONS: readonly Migration[] = [
...

  {
    ...
    up: `
      ...
      --
      -- \`treasury_subject\` is the ledger subject this community's money lives under, and it is
      -- DERIVED rather than supplied: the CHECK below pins it to 'community:' || id. A subject a
      -- caller could choose is a subject a caller could point at somebody else's treasury.
      create table if not exists communities (
        ...
        treasury_subject  text        not null,
        ...
        -- Derived, not supplied. See the comment above the table.
        constraint communities_treasury_subject_ck check (treasury_subject = 'community:' || id::text)
      );
